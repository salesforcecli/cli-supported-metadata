...
This list compares metadata types found in the [Metadata Coverage Report v53](https://developer.salesforce.com/docs/metadata-coverage/53) with the metadata info file shipped with [salesforce-alm@53.5.0](https://www.npmjs.com/package/salesforce-alm).
